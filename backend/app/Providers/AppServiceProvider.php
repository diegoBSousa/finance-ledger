...
use App\Infrastructure\Persistence\MysqlDashboardInvalidationRepository;
use App\Infrastructure\Persistence\MysqlDashboardRepository;
...
use App\Infrastructure\Persistence\MysqlImportRowsRepository;
use App\Infrastructure\Persistence\MysqlJournalRepository;
use App\Infrastructure\Persistence\MysqlLedgerReadRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->bind(DashboardCache::class, RedisDashboardCache::class);
        $this->app->bind(ImportRowsRepository::class, MysqlImportRowsRepository::class);
        $this->app->bind(LedgerReadRepository::class, MysqlLedgerReadRepository::class);
        $this->app->bind(DashboardInvalidationRepository::class, MysqlDashboardInvalidationRepository::class);
        $this->app->bind(DashboardRepository::class, MysqlDashboardRepository::class);
